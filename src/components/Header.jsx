        ...
        <>
            ...
            >
                <div className="container mx-auto px-4">
                    <div className="h-20 flex items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            ...
                            <div className="relative group">
                                ...
                                <div
                                    className={`absolute top-full mt-3 w-40 rounded-2xl bg-white shadow-xl border border-black/5 p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ${isRTL ? "left-0" : "right-0"
                                        }`}
                                >
                                    <button
                                        type="button"
                                        onClick={() => setLanguage("ar")}
                                        className={`w-full px-4 py-2 rounded-xl text-sm font-medium transition ${language === "ar"
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-4 py-2 rounded-xl text-sm font-medium transition ${language === "en"
                                                ? "bg-[#C0265C] text-white"
                                                : "text-[#191D2B] hover:bg-[#FBF7EF]"
                                            }`}
                                    >
                    ...
                    {/* Mobile Menu */}
                    <div
                        className={`lg:hidden overflow-hidden transition-all duration-500 ${isMenuOpen ? "max-h-[520px] pb-5" : "max-h-0"
                            }`}
                    >
